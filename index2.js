...
Score.getScores().then(scores => {
  const topScores = scores.slice(0, 5);
  console.log(topScores);
  // display the top scores on the page
  // ...
}).catch(error => {
  console.error(error);
});
...
async function updateScores() {
  ...
  scoresContainer.innerHTML = 'scores.txt';
...
const scoreboardEl = document.getElementById("leaderboard");
